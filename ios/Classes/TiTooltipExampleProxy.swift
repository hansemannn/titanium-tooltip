...
@objc(TiTooltipExampleProxy)
class TiTooltipExampleProxy: TiProxy {

  override func _init(withPageContext context: TiEvaluator!) -> TiTooltipExampleProxy! {
