...
public class TitaniumTooltipModule extends KrollModule {
	...
	public void show(final KrollDict params) {
		...
		activeTooltip = ViewTooltip.on(TiApplication.getInstance().getCurrentActivity(), sourceView.getOrCreateView().getNativeView())
			.text(title)
			.clickToHide(true)
			.padding(padding, padding - (padding / 3), padding, padding)
			.autoHide(false, 2000)
			...
			.border(Utils.getColor(params, Defaults.PARAMS_BORDER_COLOR, "transparent"), params.optInt(Defaults.PARAMS_BORDER_WIDTH, Defaults.Values.BORDER_WIDTH) )
